/**
 * V4 MICRO-TASKS — Four tasks embedded in MemoVoice conversations
 * for targeted cognitive/motor assessment. Each maps to V4 indicators
 ...
 * @param {Object} patientProfile - { riskFlags: {alzheimer,depression,parkinson}, age, lastTasks: [{taskId,weekNumber}] }
