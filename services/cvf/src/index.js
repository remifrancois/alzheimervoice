/**
 * CVF Engine Service — cvf.alzheimervoice.com
 *
 * Internal microservice for Cognitive Voice Fingerprint computation.
 * Called exclusively by the API gateway (api.alzheimervoice.com).
 *
...
try {
  ...
  console.log(`  V1: /cvf/v1/* | V2: /cvf/v2/* | V3: /cvf/v3/*\n`);
} catch (err) {
  app.log.error(err);
  process.exit(1);
}
